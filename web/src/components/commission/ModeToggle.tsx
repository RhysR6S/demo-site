...
export function ModeToggle({ mode, onChange }: ModeToggleProps) {
  return (
    <div className="bg-slate-900 border border-zinc-800 rounded-lg p-6 mb-6">
      ...
      <div className="text-sm text-gray-400">
        {mode === 'simple' ? (
          <p>
            <span className="text-cyan-400 font-medium">Simple Mode:</span> Quick and easy sliders for common preferences. 
            Perfect for most users who want to specify basic content preferences.
          </p>
        ) : (
          <p>
            <span className="text-cyan-400 font-medium">Advanced Mode:</span> Full control over all content tags with precise weights. 
